...
/* GÖREV 2:
	...
	*/
	...
	function paragrafOlustur(par1, cumkurpara, cumdonpara){
		let cumledizi = (cumdonpara(par1, " "));
		return cumkurpara(cumledizi[1], cumledizi[3], cumledizi[5], cumledizi[7], cumledizi[9]);
 ...
 */
			...
			console.log(
				emojileriDonustur(
					"Hey :) :D Ödevi teslim ettin mi :P Baya zor 😱 Ne yapacağımı bilmiyorum :( Biraz yardıma ihtiyacım var sanırım <3",
					emojiler
				)
			);
